package me.cirex.client.gui.csgogui.buttons.setting.settings;
...
public class CSSettingCheck extends CSSetting {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		Gui.drawFullCircle(x + stringwidth + 20, y + 5, 5, 0xFF000000);
		Gui.drawFullCircle(x + stringwidth + 30, y + 5, 5, 0xFF000000);
		Gui.drawFullCircle(x + stringwidth + animation, y + 5, 5, Integer.MAX_VALUE * 2);
